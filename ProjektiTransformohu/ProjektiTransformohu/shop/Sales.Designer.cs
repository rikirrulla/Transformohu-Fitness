...
namespace ProjektiTransformohu.shop {
    ...
    public partial class Sales : global::System.Data.DataSet {
        ...
        public partial class salesDataTable : global::System.Data.TypedTableBase<salesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public salesRow AddsalesRow(string username, System.DateTime Date_Sold, string ProductName, int Quantity, double UnitPrice, double TotalAmount) {
...
namespace ProjektiTransformohu.shop.SalesTableAdapters {
    ...
    public partial class salesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [sales] WHERE (([ID] = @Original_ID) AND ([username] = @Original_username) AND ([Date_Sold] = @Original_Date_Sold) AND ([ProductName] = @Original_ProductName) AND ([Quantity] = @Original_Quantity) AND ([UnitPrice] = @Original_UnitPrice) AND ([TotalAmount] = @Original_TotalAmount))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_username", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "username", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Date_Sold", global::System.Data.SqlDbType.Date, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Date_Sold", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [sales] ([username], [Date_Sold], [ProductName], [Quantity], [UnitPrice], [TotalAmount]) VALUES (@username, @Date_Sold, @ProductName, @Quantity, @UnitPrice, @TotalAmount);
SELECT ID, username, Date_Sold, ProductName, Quantity, UnitPrice, TotalAmount FROM sales WHERE (ID = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@username", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "username", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Date_Sold", global::System.Data.SqlDbType.Date, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Date_Sold", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [sales] SET [username] = @username, [Date_Sold] = @Date_Sold, [ProductName] = @ProductName, [Quantity] = @Quantity, [UnitPrice] = @UnitPrice, [TotalAmount] = @TotalAmount WHERE (([ID] = @Original_ID) AND ([username] = @Original_username) AND ([Date_Sold] = @Original_Date_Sold) AND ([ProductName] = @Original_ProductName) AND ([Quantity] = @Original_Quantity) AND ([UnitPrice] = @Original_UnitPrice) AND ([TotalAmount] = @Original_TotalAmount));
SELECT ID, username, Date_Sold, ProductName, Quantity, UnitPrice, TotalAmount FROM sales WHERE (ID = @ID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@username", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "username", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Date_Sold", global::System.Data.SqlDbType.Date, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Date_Sold", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Date_Sold", global::System.Data.SqlDbType.Date, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Date_Sold", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ProjektiTransformohu.Properties.Settings.Default.TransformohuDBEntitiesConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        ID, username, Date_Sold, ProductName, Quantity, UnitPrice, TotalAmo" +
                "unt\r\nFROM            sales\r\nWHERE        (Date_Sold BETWEEN @FROM AND @TO)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@FROM", global::System.Data.SqlDbType.Date, 3, global::System.Data.ParameterDirection.Input, 0, 0, "Date_Sold", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@TO", global::System.Data.SqlDbType.Date, 3, global::System.Data.ParameterDirection.Input, 0, 0, "Date_Sold", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(Sales.salesDataTable dataTable, string FROM, string TO) {
        ...
        public virtual Sales.salesDataTable GetData(string FROM, string TO) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((FROM == null)) {
                throw new global::System.ArgumentNullException("FROM");
            }
        ...
        public virtual int Delete(int Original_ID, string Original_username, System.DateTime Original_Date_Sold, string Original_ProductName, int Original_Quantity, double Original_UnitPrice, double Original_TotalAmount) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((System.DateTime)(Original_Date_Sold));
        ...
        public virtual int Insert(string username, System.DateTime Date_Sold, string ProductName, int Quantity, double UnitPrice, double TotalAmount) {
            if ((username == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((System.DateTime)(Date_Sold));
            if ((ProductName == null)) {
        ...
        public virtual int Update(string username, System.DateTime Date_Sold, string ProductName, int Quantity, double UnitPrice, double TotalAmount, int Original_ID, string Original_username, System.DateTime Original_Date_Sold, string Original_ProductName, int Original_Quantity, double Original_UnitPrice, double Original_TotalAmount, int ID) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((System.DateTime)(Date_Sold));
            if ((ProductName == null)) {
                throw new global::System.ArgumentNullException("ProductName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((System.DateTime)(Original_Date_Sold));
            if ((Original_ProductName == null)) {
                throw new global::System.ArgumentNullException("Original_ProductName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, System.DateTime Date_Sold, string ProductName, int Quantity, double UnitPrice, double TotalAmount, int Original_ID, string Original_username, System.DateTime Original_Date_Sold, string Original_ProductName, int Original_Quantity, double Original_UnitPrice, double Original_TotalAmount) {
            return this.Update(username, Date_Sold, ProductName, Quantity, UnitPrice, TotalAmount, Original_ID, Original_username, Original_Date_Sold, Original_ProductName, Original_Quantity, Original_UnitPrice, Original_TotalAmount, Original_ID);
        }
    }
